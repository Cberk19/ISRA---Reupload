<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Advisor_Search.aspx.cs" Inherits="ISRA.Advisor_Search" %>
        ...
        <div class="d-flex position-relative" style="top: 70px;">
            ...
            <div id="results" class="container my-5">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <asp:Button ID="btnExport" runat="server" CssClass="btn btn-danger" Text="Export as CSV" OnClick="btnExport_Click"/>
                </div>
                ...
                <table class="w-100">
                    <tr class="border-bottom">
                        <th id="tableID" runat="server" class="fw-normal text-secondary">ID</th>
                        <th id="tableRequester" runat="server" class="fw-normal text-secondary">Requester</th>
                        <th id="tableCourse" runat="server" class="fw-normal text-secondary">Course</th>
                        <th id="tableSemester" runat="server" class="fw-normal text-secondary">Semester</th>
                        <th id="tableStatus" runat="server" class="fw-normal text-secondary">Status</th>
                        <th id="tableDate" runat="server" class="fw-normal text-secondary">Date</th>
                    </tr>
