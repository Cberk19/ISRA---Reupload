<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FacultyMember_Search.aspx.cs" Inherits="ISRA.FacultyMember_Search" %>
...
<body>
    <form id="form1" runat="server">
        <nav class="navbar navbar-expand-lg navbar-dark position-absolute w-100 top-0" style="z-index: 1;">
          <div class="container-fluid">
            <span class="navbar-brand" >
                <a href="FacultyMember_Search.aspx">
